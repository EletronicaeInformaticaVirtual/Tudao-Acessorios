...
var thumb44 =  document.getElementById("thumb44");
var thumb44Src =  document.getElementById("thumb44").src;
...
thumb44.addEventListener("click",function(){
	document.getElementById("mainImg1").src = thumb44Src
